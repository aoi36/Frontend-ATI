...
function CalendarPage() {
  ...
  return (
    <div className="calendar-page">
      ...
      {success && <div className="success-alert" onClick={() => setSuccess(null)}>{success}</div>}
      ...
      <div className="calendar-controls">
        <Card className="control-card">
          ...
          <div className="button-group">
            ...
            <button onClick={handleGeneratePlan} disabled={planLoading} className="submit-button secondary">
        ...
        <Card className="control-card">
          ...
          <form onSubmit={handleUpdateSettings}>
            <p>Your current calendar ID is: <strong>{currentCalendarId}</strong></p>
